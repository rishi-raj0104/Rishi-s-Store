...
import {
  ...
  BreadcrumbLink,
  BreadcrumbList,
  BreadcrumbPage, // Although not explicitly used for the last item in the image, good to keep if from original snippet
  BreadcrumbSeparator,
        ...
        {breadcrumbData.length > 0 &&
          breadcrumbData.map((data, index) => {
            return index !== breadcrumbData.length - 1 ? (
              ...
              // For the last item (no separator after it)
              <div key={index} className="flex items-center">
                <BreadcrumbItem>
