      ...
      <div className="lg:px-32 px-5 my-20">
        {orderData && !orderData.success ? (
          ...
          <>
            <div className="mb-5">
              <p>
                <b>Order Id:</b> {orderData?.data?.order_id}
              </p>
              <p>
                <b>Transaction Id:</b> {orderData?.data?.payment_id}
              </p>
                  ...
                  <table className="w-full">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="text-end py-2">
                          {orderData?.data?.couponDiscountAmount.toLocaleString("en-IN", {
                            style: "currency",
                            currency: "INR",
                          })}
                        </td>
                      ...
                      <tr>
                        ...
                        <td className="text-end py-2">
                          {orderData?.data?.totalAmount.toLocaleString("en-IN", {
                            style: "currency",
                            currency: "INR",
                          })}
                        </td>
