...
const Checkout = () => {
  ...
  const authStore = useSelector((auth) => auth.authStore);
  ...
  useEffect(() => {
    ...
    couponForm.setValue("minShoppingAmount", totalAmount);
  }, [cart]);
  ...
  const placeOrder = async (formData) => {
    ...
    if (!authStore || !authStore.auth || !authStore.auth._id) {
    ...
    try {
      ...
      const razOption = {
        ...
        image:
          "https://res.cloudinary.com/dnpbc1yzm/image/upload/v1759683079/ouchidg9nqe4umqjnhfj.png",
        order_id: order_id,
