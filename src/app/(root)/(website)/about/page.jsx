  ...
  return (
    <div>
      ...
      <div className="lg:px-40 px-5 py-20">
        ...
        <p>
          Welcome to Rishi's Store, your one-stop destination for quality,
        ...
        <p className="mt-3">
          Thank you for choosing Rishi's Store. Let&apos; make shopping smarter,
          simpler, and more enjoyable—together.
        </p>
      </div>
    </div>
  );
