  ...
  return (
    <div>
      ...
      <div className="lg:px-40 px-5 py-20">
        ...
        <p>
          Welcome to Rishi's Store. By accessing or using our website, you agree to be
        ...
        <ul className="list-disc ps-10 mt-3">
          <li>
            All content on Rishi's Store, including logos, images, and text, is the
            property of Rishi's Store and protected by copyright laws.
          </li>
          <li>
        ...
        <p className="mt-3">
          Thank you for choosing Rishi's Store. We value your trust and are committed
